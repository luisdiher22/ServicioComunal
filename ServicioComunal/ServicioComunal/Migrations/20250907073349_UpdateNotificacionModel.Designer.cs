...
namespace ServicioComunal.Migrations
{
    ...
    [Migration("20250907073349_UpdateNotificacionModel")]
    partial class UpdateNotificacionModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServicioComunal.Models.Notificacion", b =>
                {
                    ...
                    b.Property<int>("UsuarioDestino")
                        .HasColumnType("int")
                        .HasColumnName("UsuarioDestino");

                    b.Property<int?>("UsuarioOrigen")
                        .HasColumnType("int")
                        .HasColumnName("UsuarioOrigen");
            ...
            modelBuilder.Entity("ServicioComunal.Models.Notificacion", b =>
                {
                    b.HasOne("ServicioComunal.Models.Entrega", "Entrega")
                        .WithMany()
                    ...
                    b.HasOne("ServicioComunal.Models.Grupo", null)
                        .WithMany("Notificaciones")
                        .HasForeignKey("GrupoNumero");

                    b.HasOne("ServicioComunal.Models.Profesor", null)
                        .WithMany("Notificaciones")
                        .HasForeignKey("ProfesorIdentificacion");

                    b.HasOne("ServicioComunal.Models.Usuario", "UsuarioDestinoNavigation")
                        .WithMany()
                        .HasForeignKey("UsuarioDestino")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ServicioComunal.Models.Usuario", "UsuarioOrigenNavigation")
                        .WithMany()
                    ...
                    b.Navigation("UsuarioDestinoNavigation");

                    b.Navigation("UsuarioOrigenNavigation");
                });
